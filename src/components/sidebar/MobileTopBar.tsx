...
export function MobileTopBar() {
  ...
  return (
    <nav
      className={cn(
        "fixed inset-x-4 top-4 z-20 flex overflow-hidden rounded-t-2xl rounded-b-full corner-squircle border border-border/50 bg-sidebar/90 shadow-lg backdrop-blur-sm transition-transform duration-200 ease-in-out sm:hidden",
